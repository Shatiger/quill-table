...
var TableCell = function (_ContainBlot) {
    ...
    (0, _createClass3.default)(TableCell, [{
        ...
        value: function formats() {
            // We don't inherit from FormatBlot
            return (0, _defineProperty3.default)({}, this.statics.blotName, this.domNode.getAttribute('table_id') + '|' + this.domNode.getAttribute('row_id') + '|' + this.domNode.getAttribute('cell_id') + '|' + this.domNode.style.width);
        }
    }, {
        key: 'optimize',
        value: function optimize(context) {
...
var _TableCellBlot = __webpack_require__(47);
...
var TableModule = function () {
    function TableModule(quill, options) {
        ...
        clipboard.addMatcher('TD', function (node, delta) {
            var td = node.getAttribute('table_id') + '|' + node.getAttribute('row_id') + '|' + node.getAttribute('cell_id');
    ...
    (0, _createClass3.default)(TableModule, [{
        ...
        value: function mouseDownHandler(e) {
            ...
            var styles = window.getComputedStyle(this.resize.parentElement);
        ...
        value: function mouseUpHandler() {
            ...
            delta = new _quillDelta2.default().delete(1);
            this.quill.updateContents(delta, 'user');
        }
    }, {
        key: 'addResizeElement',
        value: function addResizeElement() {
            var _this = this;

            setTimeout(function () {
                _this.quill.root.querySelectorAll('td').forEach(function (td) {
                    if (!td.querySelector('.resize')) {
                        _TableTrick2.default.createResizeElement(td);
                    }
                });
            });
        }
